...
O **[AppKit](/pt/docs/appkit/v0)** é o SDK TypeScript para criar esses aplicativos. Ele oferece componentes de interface React prontos, acesso a dados com tipagem segura e um sistema de plugins para conexão com os serviços do Databricks.
...
| ---------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**server**](/pt/docs/appkit/v0/plugins/server)         | Servidor HTTP Express, entrega de arquivos estáticos, modo de desenvolvimento do Vite (sempre incluído)                                                                        |
| [**lakebase**](/pt/docs/appkit/v0/plugins/lakebase)     | Pool de conexões Postgres para o [Lakebase Postgres](/pt/docs/lakebase/quickstart) com renovação automática de token OAuth                                                        |
| [**analytics**](/pt/docs/appkit/v0/plugins/analytics)   | Execução de consultas SQL em [SQL warehouses do Databricks](https://docs.databricks.com/aws/en/compute/sql-warehouse/). Consulte [Leituras analíticas](/pt/docs/lakehouse/analytical-reads). |
| [**genie**](/pt/docs/appkit/v0/plugins/genie)           | Integração com o [Genie Agent](/pt/docs/agents/genie) para consultas de dados em linguagem natural                                                                                  |
| [**serving**](/pt/docs/appkit/v0/plugins/model-serving) | Proxy autenticado para endpoints do [Model Serving](/pt/docs/agents/ai-gateway) com suporte a streaming                                                                             |
| [**files**](/pt/docs/appkit/v0/plugins/files)           | Operações com arquivos em [Volumes do Unity Catalog](https://docs.databricks.com/aws/en/files/)                                                                                  |
| [**agents**](/pt/docs/appkit/v0/plugins/agents)         | Agentes de IA definidos em markdown ou código, com descoberta automática de ferramentas                                                                                          |
| [**ai-search**](/pt/docs/appkit/v0/plugins/ai-search)   | Busca semântica e vetorial nos seus índices do AI Search                                                                                                                        |
| [**jobs**](/pt/docs/appkit/v0/plugins/jobs)             | Acione e monitore [Databricks Lakeflow Jobs](/pt/docs/lakehouse/jobs)                                                                                                              |
| [**caching**](/pt/docs/appkit/v0/plugins/caching)       | Cache de respostas global e por plugin, com suporte do [Lakebase Postgres](/pt/docs/lakebase/quickstart) quando disponível                                                          |

Para ver o conjunto completo e atualizado de plugins, consulte a [referência de plugins](/pt/docs/appkit/v0/plugins).
...
Os [Templates](/pt/templates) são prompts prontos para agentes, organizados por caso de uso. Encontre o que melhor se encaixa no seu cenário ou consulte o [Guia rápido de Apps](/pt/docs/apps/quickstart) para ver um passo a passo detalhado.