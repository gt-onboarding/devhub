...
description: Crie aplicativos internos no workspace do Databricks que sua empresa já utiliza. O DevHub oferece templates, o SDK do AppKit e documentação complementar.
sourceOfTruth:
  skills:
    - databricks-core
    - databricks-apps
...
## O que é o DevHub? \{#what-is-devhub\}

O DevHub é o recurso para desenvolvedores que criam **aplicativos empresariais** com o Databricks.

## Por que criar aplicativos empresariais no Databricks? \{#why-enterprise-apps-on-databricks\}
...
Os apps criados no Databricks são executados em um **workspace do Databricks**.

> Não sabe ao certo o que é um workspace? Pergunte ao administrador do Databricks da sua equipe, faça um [teste gratuito](https://databricks.com/signup) ou conheça o [Databricks Free Edition](https://databricks.com/learn/free-edition) para criar o seu próprio workspace.

Os workspaces são isolados, seguros e governados. Para cada app que você cria, o workspace define quem pode fazer login e quais dados o app pode ler e gravar. Hospedagem, autenticação e rede já vêm prontas, para que você possa se concentrar na lógica principal do seu app em vez da infraestrutura.
