...
Avec la [Databricks CLI](/fr/docs/tools/databricks-cli), les [compétences d&#39;agent](/fr/docs/tools/ai-tools/agent-skills) et le Docs MCP Server installés, votre agent de codage dispose de tout ce qu&#39;il faut pour développer et déployer.

Prêt à vous lancer ? Découvrez comment les [modèles](/fr/docs/templates) vous aident à générer rapidement la structure de votre projet, ou parcourez directement le [catalogue de modèles](/fr/templates).