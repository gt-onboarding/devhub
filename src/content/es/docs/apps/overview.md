...
**[AppKit](/docs/appkit/v0)** es el SDK de TypeScript para crear esas aplicaciones. Incluye componentes de interfaz React listos para usar, acceso a datos con tipado seguro y un sistema de plugins para conectarse a los servicios de Databricks.
...
| Plugin                                               | Qué aporta                                                                                                                                                                  |
| ---------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**server**](/docs/appkit/v0/plugins/server)         | Servidor HTTP Express, servicio de archivos estáticos, modo de desarrollo de Vite (siempre incluido)                                                                                                     |
| [**lakebase**](/docs/appkit/v0/plugins/lakebase)     | Pool de conexiones Postgres para [Lakebase Postgres](/docs/lakebase/quickstart) con refresh automático del token de OAuth                                                                |
| [**analytics**](/docs/appkit/v0/plugins/analytics)   | Ejecución de consultas SQL sobre [SQL warehouses de Databricks](https://docs.databricks.com/aws/en/compute/sql-warehouse/). Consulta [Analytical reads](/docs/lakehouse/analytical-reads). |
| [**genie**](/docs/appkit/v0/plugins/genie)           | Integración con [Genie Agent](/docs/agents/genie) para consultas de datos en lenguaje natural                                                                                               |
| [**serving**](/docs/appkit/v0/plugins/model-serving) | Proxy autenticado a endpoints de [Model Serving](/docs/agents/ai-gateway) con soporte de streaming                                                                              |
| [**files**](/docs/appkit/v0/plugins/files)           | Operaciones con archivos sobre [volúmenes de Unity Catalog](https://docs.databricks.com/aws/en/files/)                                                                                    |
| [**agents**](/docs/appkit/v0/plugins/agents)         | Agentes de IA definidos en markdown o en código, con descubrimiento automático de herramientas                                                                                               |
| [**ai-search**](/docs/appkit/v0/plugins/ai-search)   | Búsqueda semántica y vectorial sobre tus índices de AI Search                                                                                                                        |
| [**jobs**](/docs/appkit/v0/plugins/jobs)             | Activa y supervisa [Lakeflow Jobs de Databricks](/docs/lakehouse/jobs)                                                                                                          |
| [**caching**](/docs/appkit/v0/plugins/caching)       | Caché de respuestas a nivel global y de plugin, respaldada por [Lakebase Postgres](/docs/lakebase/quickstart) cuando está disponible                                                             |

Para ver el conjunto completo y actualizado de plugins, consulta la [referencia de plugins](/docs/appkit/v0/plugins).
...
De forma predeterminada, todas las solicitudes se ejecutan como ese service principal y todos los usuarios comparten sus permisos. Cuando necesites acceso a datos por usuario, Databricks puede reenviar el token del usuario autenticado mediante `x-forwarded-access-token`. Los plugins integrados de AppKit para [Genie](/docs/agents/genie) y [Model Serving](/docs/agents/ai-gateway) lo hacen automáticamente.
...
Las [plantillas](/templates) son prompts listos para agentes organizados por caso de uso. Busca la que mejor se adapte a tu caso o consulta la [guía de inicio rápido de Apps](/docs/apps/quickstart) para ver un recorrido paso a paso.